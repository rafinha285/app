...
export declare function sendError(res: express.Response, status: number, menssage: string): {
    notId: (res: express.Response) => void;
    und: (res: express.Response) => void;
    exist: (res: express.Response) => void;
};
