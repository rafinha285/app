    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, req.db.execute("SELECT id, name, description,rating FROM anime WHERE name LIKE :search OR name2 LIKE :search ALLOW FILTERING", { search: "%".concat(search, "%") }, { prepare: true })];
            case 1:
                result = _a.sent();
