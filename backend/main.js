...
var userPostRoutes_1 = require("./routes/userPostRoutes");
...
var animePostRoutes_1 = require("./routes/animePostRoutes");
...
//rotas para usuario
app.use('/user/p/', userPostRoutes_1.default);
app.use('/user/g/', userGetRoutes_1.default);
//rotas para animelist
app.use('/user/animelist', animelistRoutes_1.default);
//rotas para anime
app.use('/ani/g/', animeGetRoutes_1.default);
app.use('/ani/p/', animePostRoutes_1.default);
...
app.listen(4433, '0.0.0.0', function () {
