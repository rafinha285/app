...
const Watch:React.FC = () =>{
    ...
    const [epUser,setEpUser] = useState<EpisodeUser|undefined>()
    ...
    return(
        <>
            {ani&&eps?(
                ...
                {ep&&ani&&seasonId?
                    <>
                        <PlayerPopup ref={popupRef} plyrRef={plyrRef}/>
                        <Player ep={ep} ani={ani} seasonId={seasonId} eps={eps} ref={plyrRef}/>
                    </>
                    :<></>}
