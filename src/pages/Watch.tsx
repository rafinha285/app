...
const Watch:React.FC = () => {
    ...
    const initPlyr = async () => {
        ...
        let buOp = (<div className="skip-intro plyr__controls__item plyr__control"
                         onClick={() => handleSkipIntro(ep?.openingend!)}>
        ...
        let buEd = (<div className="skip-intro plyr__controls__item plyr__control">
        ...
        function handleTimeUpdate() {
            ...
            if (sec >= ep?.openingstart! && sec <= ep?.openingend! && ep?.epindex! != Math.min(...seasonEp.map((v) => v.epindex))) {
    ...
    window.addEventListener("beforeunload",function(e){
        handlePostSec(plyrRef.current!.plyr!.currentTime)
                ...
                <html lang='pt-BR'>
                    ...
                    {ep && ani && seasonId ?
                        <div style={{display: "flex", justifyContent: "center"}}>
                            ...
                            <Plyr source={getResolutions(ep.resolution)} ref={plyrRef} options={optionsPlyr}/>
                        </div>
                        : <></>}
