...
import {Episode, EpisodeDTO, EpisodeUser} from "../../types/Episode";
...
import {fetchUser, getFromApi} from "../../functions/requestFunctions.ts";




const WatchOld:React.FC = () =>{
    ...
    useEffect(()=>{
        const fetchData = async () => {
            try {
                const episode = await getFromApi<EpisodeDTO>(`/episode/${id}/${seasonId}/${epId}`);
